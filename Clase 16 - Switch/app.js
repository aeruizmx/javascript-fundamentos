...
switch (signo) {
  ...
  case 'cancer':
    ...
    break
  case 'leo':
    console.log('Nunca se olvide que debe mantener siempre la serenidad frente a los inconvenientes que vive, ya que será su mejor antídoto para combatir la incertidumbre.')
    break
  case 'virgo':
  ...
  case 'piscis':
    ...
    break
  default:
    console.log('No es signo zodiacal')
    break
}
